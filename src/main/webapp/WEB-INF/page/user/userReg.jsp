...
<head>
	...
	<link href="${ctx}/css/global/header.css" rel="stylesheet" type="text/css" />
	<link href="${ctx}/css/global/reg.css" rel="stylesheet" type="text/css" />
	<script src="${ctx}/js/FoshanRen.js" type="text/javascript"></script>
	...
	function checkUsername(){
		...
		var url = '${ctx}/register/checkLoginName?userName=' + username
		viewobj.innerHTML = "正在检测中...";
		send_request(function(value){viewobj.innerHTML=value}, url, true);
	}
...
<TABLE cellSpacing=0 cellPadding=0 width=770 align=center border=0>
  <TBODY>
  <TR><TD background="${ctx}/images/login/login_03.jpg">&nbsp;</TD></TR>
  <TR>
    <TD height=15>&nbsp;</TD>
  </TR>
  <TR>
    <TD height=30><img src="${ctx}/images/login/zc.gif" width="128" height="31" /></TD>
  </TR>
 </TBODY>
</TABLE>
...
<TABLE cellSpacing=1 cellPadding=8 width="78%" align="center" bgColor="#dd9988" border=0>
  <TBODY>
  <TR>
    <TD bgColor="#ffffd5" align="left"><IMG height="17" src="${ctx}/images/buy/exclamation-error-red.gif" width="17"> <FONT color="#990000"><STRONG><SPAN class="font14">错误提示<BR></SPAN></STRONG></FONT>
...
<div id="Content">
<form action="${ctx}/register" method="post" onsubmit="javascript:return checkForm()">
